...
class UncastilloFixtures extends AbstractFixture implements OrderedFixtureInterface {
    ...
    public function load(ObjectManager $manager) {
        ...
        $image1 = new Image();
        $image1->setSrc('bundles/app/images/proyectos/rehabilitacion-de-edificios/bajada-ascensor-cota-0-uncastillo/escalera-derecha-antes');
        ...
        $image2 = new Image();
        $image2->setSrc('bundles/app/images/proyectos/rehabilitacion-de-edificios/bajada-ascensor-cota-0-uncastillo/escalera-derecha-despues');
        ...
        $image3 = new Image();
        $image3->setSrc('bundles/app/images/proyectos/rehabilitacion-de-edificios/bajada-ascensor-cota-0-uncastillo/escalera-izquierda-antes');
        ...
        $image4 = new Image();
        $image4->setSrc('bundles/app/images/proyectos/rehabilitacion-de-edificios/bajada-ascensor-cota-0-uncastillo/escalera-izquierda-despues');
        ...
        $image5 = new Image();
        $image5->setSrc('bundles/app/images/proyectos/rehabilitacion-de-edificios/bajada-ascensor-cota-0-uncastillo/rellano-izquierda-antes');
        ...
        $image6 = new Image();
        $image6->setSrc('bundles/app/images/proyectos/rehabilitacion-de-edificios/bajada-ascensor-cota-0-uncastillo/rellano-izquierda-despues');
        ...
        $image7 = new Image();
        $image7->setSrc('bundles/app/images/proyectos/rehabilitacion-de-edificios/bajada-ascensor-cota-0-uncastillo/rellano-derecha-antes');
        ...
        $image8 = new Image();
        $image8->setSrc('bundles/app/images/proyectos/rehabilitacion-de-edificios/bajada-ascensor-cota-0-uncastillo/rellano-derecha-despues');
        ...
        $image9 = new Image();
        $image9->setSrc('bundles/app/images/proyectos/rehabilitacion-de-edificios/bajada-ascensor-cota-0-uncastillo/ascensor-derecha');
        ...
        $image10 = new Image();
        $image10->setSrc('bundles/app/images/proyectos/rehabilitacion-de-edificios/bajada-ascensor-cota-0-uncastillo/ascensor-izquierda');
