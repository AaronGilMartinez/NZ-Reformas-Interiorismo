...
class SalesianosFixtures extends AbstractFixture implements OrderedFixtureInterface {
    ...
    public function load(ObjectManager $manager) {
        ...
        $image1 = new Image();
        $image1->setSrc('bundles/app/images/proyectos/reformas-de-comunidades/reparacion-patio-colegio-salesianos/fachada-antes-reforma-1');
        ...
        $image2 = new Image();
        $image2->setSrc('bundles/app/images/proyectos/reformas-de-comunidades/reparacion-patio-colegio-salesianos/fachada-antes-reforma-2');
        ...
        $image3 = new Image();
        $image3->setSrc('bundles/app/images/proyectos/reformas-de-comunidades/reparacion-patio-colegio-salesianos/fachada-despues-reforma-1');
        ...
        $image4 = new Image();
        $image4->setSrc('bundles/app/images/proyectos/reformas-de-comunidades/reparacion-patio-colegio-salesianos/fachada-despues-reforma-2');
        ...
        $image5 = new Image();
        $image5->setSrc('bundles/app/images/proyectos/reformas-de-comunidades/reparacion-patio-colegio-salesianos/fachada-despues-reforma-3');
        ...
        $image6 = new Image();
        $image6->setSrc('bundles/app/images/proyectos/reformas-de-comunidades/reparacion-patio-colegio-salesianos/fachada-despues-reforma-4');
        ...
        $image7 = new Image();
        $image7->setSrc('bundles/app/images/proyectos/reformas-de-comunidades/reparacion-patio-colegio-salesianos/patio-antes-reparaciones-1');
        ...
        $image8 = new Image();
        $image8->setSrc('bundles/app/images/proyectos/reformas-de-comunidades/reparacion-patio-colegio-salesianos/patio-antes-reparaciones-10');
        ...
        $image9 = new Image();
        $image9->setSrc('bundles/app/images/proyectos/reformas-de-comunidades/reparacion-patio-colegio-salesianos/patio-antes-reparaciones-11');
        ...
        $image10 = new Image();
        $image10->setSrc('bundles/app/images/proyectos/reformas-de-comunidades/reparacion-patio-colegio-salesianos/patio-antes-reparaciones-12');
        ...
        $image11 = new Image();
        $image11->setSrc('bundles/app/images/proyectos/reformas-de-comunidades/reparacion-patio-colegio-salesianos/patio-antes-reparaciones-2');
        ...
        $image12 = new Image();
        $image12->setSrc('bundles/app/images/proyectos/reformas-de-comunidades/reparacion-patio-colegio-salesianos/patio-antes-reparaciones-3');
        ...
        $image13 = new Image();
        $image13->setSrc('bundles/app/images/proyectos/reformas-de-comunidades/reparacion-patio-colegio-salesianos/patio-antes-reparaciones-4');
        ...
        $image14 = new Image();
        $image14->setSrc('bundles/app/images/proyectos/reformas-de-comunidades/reparacion-patio-colegio-salesianos/patio-antes-reparaciones-5');
        ...
        $image15 = new Image();
        $image15->setSrc('bundles/app/images/proyectos/reformas-de-comunidades/reparacion-patio-colegio-salesianos/patio-antes-reparaciones-6');
        ...
        $image16 = new Image();
        $image16->setSrc('bundles/app/images/proyectos/reformas-de-comunidades/reparacion-patio-colegio-salesianos/patio-antes-reparaciones-7');
        ...
        $image17 = new Image();
        $image17->setSrc('bundles/app/images/proyectos/reformas-de-comunidades/reparacion-patio-colegio-salesianos/patio-antes-reparaciones-8');
        ...
        $image18 = new Image();
        $image18->setSrc('bundles/app/images/proyectos/reformas-de-comunidades/reparacion-patio-colegio-salesianos/patio-antes-reparaciones-9');
        ...
        $image19 = new Image();
        $image19->setSrc('bundles/app/images/proyectos/reformas-de-comunidades/reparacion-patio-colegio-salesianos/patio-despues-reparaciones-1');
        ...
        $image20 = new Image();
        $image20->setSrc('bundles/app/images/proyectos/reformas-de-comunidades/reparacion-patio-colegio-salesianos/patio-despues-reparaciones-2');
