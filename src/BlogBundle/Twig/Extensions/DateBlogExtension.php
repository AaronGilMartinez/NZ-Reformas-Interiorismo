...
// src/BlogBundle/Twig/Extensions/DateBlogExtension.php

namespace BlogBundle\Twig\Extensions;

class DateBlogExtension extends \Twig_Extension {
    ...
    public function createdAgo(\DateTime $dateTime) {
        ...
        if ($delta < 0)
            throw new \Exception("createdAgo no puede ver el futuro");
