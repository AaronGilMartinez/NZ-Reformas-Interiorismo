...
class RehabilitacionFachadasZaragozaFixtures extends AbstractFixture implements OrderedFixtureInterface {
    ...
    public function load(ObjectManager $manager) {
        ...
        $article->setArticle('<p>La realización de reformas en una comunidad, puede implicar una 
            rehabilitación de fachadas en Zaragoza, o en el lugar en el que residamos.  Es por ello 
            ...
            el sector de la construcción. La rehabilitación de fachadas en Zaragoza, podría ser uno 
            ...
            rehabilitación de fachadas en Zaragoza, una vía para conseguir volver a funcionar y 
            recuperarse en este ámbito. De hecho, realizando la correcta rehabilitación de fachadas,
            ...
            <p>Así, la rehabilitación de fachadas en Zaragoza, supone un beneficio, no sólo para la 
        ...
        $article->setImage('rehabilitacion-fachadas-zaragoza.jpg');
