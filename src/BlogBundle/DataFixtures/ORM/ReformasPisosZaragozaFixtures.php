...
class ReformasPisosZaragozaFixtures extends AbstractFixture implements OrderedFixtureInterface {
    ...
    public function load(ObjectManager $manager) {
        $article = new Article();
        $article->setTitle('Reformas de pisos en Zaragoza');
        $article->setArticle('<p>En todas las ciudades y pueblos, los edificios más antiguos, son 
            los que en la mayoría de los casos necesitan reformas en pisos de Zaragoza, o de 
            ...
            realizar reformas en pisos en Zaragoza o en la población que corresponda. Escuchamos a 
        ...
        $article->setImage('reformas-pisos-zaragoza.jpg');
