...
class ReformasZaragozaFixtures extends AbstractFixture implements OrderedFixtureInterface {
    ...
    public function load(ObjectManager $manager) {
        $article = new Article();
        $article->setTitle('Reformas en Zaragoza mucho más que un proyecto constructivo');
        $article->setArticle('<p>A la hora de tener que realizar reformas en Zaragoza o en cualquier
            ...
            para asesorar y orientar a todas las personas que requieran de reformas en Zaragoza, 
            ...
            <p>En NZ Reformas, velamos por conseguir que nuestros clientes queden satisfechos con 
        ...
        $article->setImage('reformas-zaragoza.jpg');
