...
class EmpresaReformasZaragozaFixtures extends AbstractFixture implements OrderedFixtureInterface {
    ...
    public function load(ObjectManager $manager) {
        $article = new Article();
        $article->setTitle('Reformas, mucho más que una de las empresas de reformas existentes en Zaragoza');
        $article->setArticle('<p>Una de las maneras de conseguir modificar nuestro espacio de 
            ...
            proyecto, en muchas ocasiones requiere contar con la presencia de empresas de reformas 
            en Zaragoza o en el lugar que nos encontremos. En NZ Reformas proporcionamos apoyo a la
            ...
            que sabemos que como una de las empresas de reformas en Zaragoza, 
            ...
            como profesional.</p>');
        $article->setImage('empresa-de-reformas-en-zaragoza.jpg');
